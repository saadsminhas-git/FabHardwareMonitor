...
vpk pack --packId FabHardwareMonitor --packVersion $Version --packDir publish --mainExe FabHardwareMonitor.exe --packTitle "Fab Hardware Monitor" --packAuthors "Fabric Visuals Ltd" --icon $icon --shortcuts None --msi --instLicense $license --instWelcome $welcome --instConclusion $conclusion --msiLogo $dialogBmp --msiBanner $bannerBmp --outputDir Releases
